    ...
    <div class="container first-container">
        <div class="row">
            ...
            <div class="col s8 offset-s2 red lighten-3">
                <div class="row">
                    <div class="col s2">
                        <img src="{{asset('img/')}}/{{$topic->user->avatar}}" alt="" class="circle responsive-img">
                    </div>
                    <form class="col s8 " method="post">
                        ...
                        <div class="row">
                            ...
                            <input name="topic_title" value="{{$topic->topic_title}}">
                        </div>
                        <div class="row">
                            <label class="white-text" for="message-body">text</label>
                            <textarea id="message-body" class="form-control" name="topic_text">{{$topic->topic_text}}</textarea>
                        </div>
