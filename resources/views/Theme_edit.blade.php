...
@section('content')
    ...
    <div class="container first-container">
        <div class="row">
            ...
            <h4 class="center-align">Edit theme</h4>
                ...
                <div class="row">
                    ...
                    <form class="col s8 " method="post">
                        ...
                        <div class="row">
                            ...
                            <input name="theme_title" value="{{$theme->theme_title}}">
                        </div>
                        <div class="row">
                            <label class="white-text" for="message-body">text</label>
                            <textarea id="message-body" class="form-control" name="theme_description">{{$theme->theme_description}}</textarea>
                        </div>
